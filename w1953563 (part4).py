...
while True:
        ...
        if len(student_id) == 8:
            ...
            with open('coursework.txt','w') as file:     #creating a text file. 
                file.write("\n".join(student_results))    #inserting data to the text file created. 
                
  
            with open('coursework.txt','r') as file:
                contents = file.read()                   #reading the text file. / Taken from 'stackflow'
                print(contents) 
                print()


                
                student_marks = student_mark.items()
                for i in student_marks:
                    final_results = i[0] + " : " + str(i[1][0]) + " - " + str(i[1][1]) + ", " + str(i[1][2]) + ", " + str(i[1][3])
                    print(final_results, end = " ")
                break  

           
        else:
            print("Invalid student id, please re-enter the student id")
            print()
